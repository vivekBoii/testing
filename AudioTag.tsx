...
const AudioPropertiesTab = () => {
  ...
  return (
    <div className="propertiesTab audioTab">
      <CollapsibleSection
      ...
      >
        <div className="attributes">
          ...
          <div>
            ...
            />
            <p>
							Please use a public URL and ensure that your video
							file is not more than 100MB.
            </p>
          </div>
...
export default AudioPropertiesTab;
